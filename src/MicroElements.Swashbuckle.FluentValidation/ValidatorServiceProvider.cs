...
namespace MicroElements.Swashbuckle.FluentValidation
{
    ...
    /// as a single type used for validator purposes.
    /// <see cref="https://raw.githubusercontent.com/bUnit-dev/bUnit/main/src/bunit.core/TestServiceProvider.cs"/>.
    /// </summary>
    public sealed class ValidatorServiceProvider : IServiceProvider, IServiceCollection, IDisposable
    {
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="ValidatorServiceProvider"/> has been initialized, and
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorServiceProvider"/> class
        /// and sets its service collection to the provided <paramref name="initialServiceCollection"/>, if any.
        /// </summary>
        public ValidatorServiceProvider(IServiceCollection? initialServiceCollection = null)
            : this(initialServiceCollection ?? new ServiceCollection(), initializeProvider: false)
        {
        }

        private ValidatorServiceProvider(IServiceCollection initialServiceCollection, bool initializeProvider)
        {
        ...
        /// <summary>
        /// Get service of type T from the validator provider.
        /// </summary>
        ...
        private object? GetServiceInternal(Type serviceType)
        {
            ...
            {
                serviceCollection.AddSingleton<ValidatorServiceProvider>(this);
        ...
        private void CheckInitializedAndThrow()
        {
            if (IsProviderInitialized)
            {
                throw new InvalidOperationException(
                    ...
                    $"Services provider after the first services has been retrieved " +
